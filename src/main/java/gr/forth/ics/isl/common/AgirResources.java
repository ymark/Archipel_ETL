...
public class AgirResources {

    /* AGIR JSON  resources */
    public static final String ADDRESSE_ADMINISTRATIVE1="adresse_administrative1";
    public static final String ADDRESSE_ADMINISTRATIVE2="adresse_administrative2";
    public static final String ADDRESSE1="addresse1";
    public static final String ADDRESSE2="addresse2";
    public static final String ANNEE="annee";
    public static final String AXE_RECHERHCE_INRAP="axe_recherche_inrap";
    public static final String BUDGET_ACCORDE="budget_accorde";
    ...
    public static final String EMPLOYER="employeur";
